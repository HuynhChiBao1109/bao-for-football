...
func main() {
	...
	api.GET("/gacha/progress", gachaHandler.GetProgress)
	...
	admin.GET("/leagues", playerAdminHandler.ListLeagues)
	admin.POST("/leagues", playerAdminHandler.CreateLeague)
	admin.PUT("/leagues/:id", playerAdminHandler.UpdateLeague)
	admin.DELETE("/leagues/:id", playerAdminHandler.DeleteLeague)
