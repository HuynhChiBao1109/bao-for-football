...
CREATE TABLE skills (
  ...
  buff_type ENUM('shooting', 'passing', 'longPass', 'vision', 'defensiveAwareness', 'counterAttackAwareness', 'crossbarHandling', 'reflexes', 'aerialCatching', 'duels', 'pace', 'physical', 'defending', 'dribbling') NOT NULL,
